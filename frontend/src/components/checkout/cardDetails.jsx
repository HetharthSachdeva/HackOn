    ...
    return (
        <div className="w-[60%] mx-auto bg-[#151c2b] ring-1 ring-white/5 border-[1px] border-white/10 rounded-lg ">
            ...
            <form className='my-4 ml-10 flex flex-col gap-2'>
                ...
                <button className="w-[58%] ml-28 text-center text-sm rounded-lg bg-[#FF9900] text-black font-bold hover:bg-[#FFB145] p-[7px] mt-3 active:ring-2 active:ring-offset-1 active:ring-[#FF9900]">
                    Continue
                </button>
            </form>
        </div>
